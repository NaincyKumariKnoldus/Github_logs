...
getPrResponse=$(curl -s \
                    ...
                    'https://api.github.com/repos/NaincyKumariKnoldus/Final_Project/pulls?state=all&per_page=100&page=1')
echo $getPrResponse
# get number of PR
...
# send data to es
   curl -X POST "http://localhost:9200/github_pull_request/PR" \
